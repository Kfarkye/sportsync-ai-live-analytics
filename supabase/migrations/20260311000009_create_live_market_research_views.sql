-- Migration: create_live_market_research_views
-- Normalize live market snapshots across unified and soccer-specific tables,
-- then expose additive research views for first-goal, red-card, and timeout
-- repricing studies.
