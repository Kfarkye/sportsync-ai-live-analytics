...
serve(async (req) => {
    ...
    try {
        ...
        const leaguesRequested = body.leagues || (body.sport_key ? [body.sport_key] : (body.sport_keys || ['nba']));

        Logger.info('INGEST_ODDS_START', { leagues: leaguesRequested, active_configs: leagueMap.size });
