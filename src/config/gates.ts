...
// =============================================================================
// SYSTEM GATES & CONFIGURATION
// Rules engine for SportSync AI.
// =============================================================================
...
export const updateSystemGates = (overrides: any) => {
    // Deep merge or shallow merge depending on needs. Shallow for now.
    // In a real Google-grade app, we'd use a robust deep merge or individual key setters.
    // For hot-swapping entire sports blocks:
    if (overrides) {
