    ...
    <div className="h-(--vvh,100vh) overflow-y-auto overscroll-y-contain bg-[#F4F6FF] text-slate-900">
        ...
        <div className="mx-auto w-full max-w-7xl px-4 md:px-6 py-3">
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              <Link to="/" className="rounded-md border border-slate-300 bg-white px-2.5 py-1.5 text-[11px] font-semibold uppercase tracking-[0.12em] text-slate-600 hover:text-slate-900 hover:bg-slate-50">
                Home
              </Link>
              <Link to="/trends" className="rounded-md border border-slate-300 bg-white px-2.5 py-1.5 text-[11px] font-semibold uppercase tracking-[0.12em] text-slate-600 hover:text-slate-900 hover:bg-slate-50">
                Trends
              </Link>
            </div>
      ...
      <main className="mx-auto w-full max-w-7xl px-4 md:px-6 py-8 space-y-6">
        <section className="space-y-2">
          <h1 className="text-4xl font-bold tracking-tight text-slate-900">{leagueLabel}</h1>
          <p className="text-sm text-slate-600">Season results, standings, and advanced betting performance from `soccer_postgame`.</p>
        </section>

        <section className="rounded-2xl border border-slate-200 bg-white p-4 md:p-5 space-y-4 shadow-[0_18px_36px_-28px_rgba(30,64,175,0.24)]">
          <div className="grid gap-3 lg:grid-cols-[1fr_auto] lg:items-end">
            ...
            <div className="inline-flex rounded-xl border border-slate-300 bg-slate-50 p-1">
              <button
                ...
                className={`rounded-lg px-4 py-2 text-xs font-semibold ${view === 'results' ? 'bg-[#EFF6FF] text-[#1D4ED8] shadow-sm' : 'text-slate-500'}`}
              >
                Results
              </button>
              <button
                ...
                className={`rounded-lg px-4 py-2 text-xs font-semibold ${view === 'standings' ? 'bg-[#EFF6FF] text-[#1D4ED8] shadow-sm' : 'text-slate-500'}`}
              >
                Standings + ATS
              </button>
            </div>
          ...
          <section className="space-y-2">
            <div className="grid gap-2 sm:grid-cols-2 xl:grid-cols-4">
              {primaryMetrics.map((metric) => (
                <article key={metric.label} className="rounded-lg border border-slate-200 bg-white px-3 py-2.5 shadow-[0_10px_24px_-22px_rgba(30,64,175,0.22)]">
            ...
            <button
              ...
              className="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-left text-xs font-semibold uppercase tracking-[0.12em] text-blue-700 hover:bg-blue-50"
            >
        ...
        {loading ? (
          <section className="rounded-2xl border border-slate-200 bg-white p-8 text-center text-sm text-slate-500 shadow-[0_18px_36px_-30px_rgba(30,64,175,0.24)]">Loading report data...</section>
        ) : view === 'results' ? (
