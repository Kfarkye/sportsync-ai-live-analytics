...
export const ESSENCE = {
  colors: {
    ...
    accent: {
      // ✅ SSOT intent keys (use THESE in components)
      primary: '#0F172A',                    // slate-900 ink accent
      primaryMuted: 'rgba(15, 23, 42, 0.06)',
      ...
      // ── legacy keys (keep for compatibility, treat as non-default) ──
      emerald: '#10B981',
      emeraldMuted: 'rgba(16, 185, 129, 0.08)',
      mintEdge: 'transparent',
      amber: '#F59E0B',
      ...
      cyan: '#0F172A',     // legacy name — actually slate-900
      cyanMuted: 'rgba(15, 23, 42, 0.06)',
      // Alias accents (legacy)
      mint: '#10B981',
