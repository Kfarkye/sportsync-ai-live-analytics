        ...
        <div>
            ...
            <div className="space-y-1">
                {['Premier League', 'Champions League', 'EuroLeague'].map((league) => (
                    <button key={league} className="w-full flex items-center justify-between px-4 py-2 rounded-lg text-sm text-slate-400 hover:text-white hover:bg-slate-800 transition-colors">
                        <span>{league}</span>
                    </button>
                ))}
            </div>
