        ...
        <div className="space-y-6">
                ...
                {loading ? (
                    ...
                    streaks.map((s, i) => (
                        <StreakRow
                            key={i}
                            streak={s}
                            teamLogo={s.teamId === match.homeTeam.id ? (match.homeTeam.logo || getTeamLogo(match.homeTeam.name) || '') : (match.awayTeam.logo || getTeamLogo(match.awayTeam.name) || '')}
                        />
                    ))
                )}
            </div>
            ...
            <div>
                ...
                <div className="flex items-center justify-between rounded-[14px] border border-zinc-200 bg-white p-6 shadow-sm">
                    <div className="flex items-center gap-3">
                        <TeamLogo logo={match.homeTeam.logo || getTeamLogo(match.homeTeam.name)} className="w-8 h-8" />
