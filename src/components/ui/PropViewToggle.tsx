...
export const PropViewToggle: React.FC<PropViewToggleProps> = ({ view, onChange, className }) => {
    return (
        <div className={cn(
            "inline-flex p-1 bg-overlay-dim backdrop-blur-xl rounded-2xl border border-white/[0.05] relative overflow-hidden ring-1 ring-white/[0.05]",
            className
        )}>
            {/* Sliding Background */}
            <MotionDiv
            ...
            <button
                ...
                className={cn(
                    "relative z-10 px-5 py-2 rounded-[10px] text-caption font-black uppercase tracking-loose transition-colors duration-300 active:scale-95 tap-feedback",
