...
const MetricRow = ({
  ...
  return (
    <div className="flex flex-col gap-2 mb-4 group/row">
      ...
      <div className="h-2 w-full bg-overlay-muted rounded-full overflow-hidden relative">
        <MotionDiv
          initial={{ width: 0 }}
...
const VenueSplitsCard: React.FC<VenueSplitsCardProps> = ({ data, teamColor = '#4F46E5' }) => {
  ...
  return (
    <MotionDiv
      ...
      className="relative flex flex-col py-4 border-b border-edge-subtle last:border-0"
    >
      ...
      <div className="pb-2 flex justify-between items-start relative z-10">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            <span className="text-label font-bold text-zinc-500 uppercase tracking-widest leading-none mb-1.5">Team Analysis</span>
        ...
        <div
          className="flex flex-col items-end justify-center px-2 py-1 rounded-lg border bg-overlay-subtle border-edge"
        >
          <span className="text-nano font-black uppercase tracking-widest mb-0.5 text-zinc-500">
            Home Edge
          </span>
      ...
      <div className="py-2 flex items-center justify-between opacity-60">
        ...
        <div className="flex flex-col gap-0.5">
          <div className="flex items-center gap-1.5 text-zinc-500">
            <TrendingUp size={10} />
            <span className="text-label font-bold uppercase tracking-widest">L3 Trend</span>
          </div>
          <div className="flex items-baseline gap-1">
            ...
            <span className="text-label text-zinc-600">PPG</span>
          </div>
        </div>

        <div className="flex flex-col items-end gap-0.5">
          <div className="flex items-center gap-1.5 text-zinc-500">
            <span className="text-label font-bold uppercase tracking-widest">Sample</span>
            <Activity size={10} />
          </div>
          <span className="text-xs font-sans font-semibold tabular-nums text-zinc-300 group-hover:text-white transition-colors">
            {data.games?.total || 0} <span className="text-label text-zinc-600 font-sans font-normal">Gms</span>
          </span>
        </div>
