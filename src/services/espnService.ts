...
import { generateCanonicalGameId } from '../utils/matchRegistry';
import { debugManager } from '../lib/debug';
import { LEAGUES } from '../constants';

import { resilientFetch, logger as Logger } from '../lib/resilience';
import { supabase, isSupabaseConfigured } from '../lib/supabase';
import { EspnAdapters, Safe } from './espnAdapters';
...
export async function fetchWithFallback(url: string): Promise<any> {
    // 1. Try Edge Function (most reliable, handles caching)
