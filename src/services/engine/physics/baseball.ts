import { ExtendedMatch, TeamEfficiencyMatrix, FairTotalActive, FairTotalResult } from "../../../types/engine";
import { OddsSnapshot } from "../../../types";
import { SYSTEM_GATES } from "../../../config/gates";
import { computePitchingWHIP, safeDiv } from "../utils";
import { getBaseballState } from "../time";
