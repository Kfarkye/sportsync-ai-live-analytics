import { Match, Sport, OddsSnapshot } from "../../../types";
import { ExtendedMatch, TeamEfficiencyMatrix, FairTotalResult, FairTotalActive } from "../../../types/engine";
import { SYSTEM_GATES } from "../../../config/gates";
import { getElapsedSeconds, isCollegeBasketball, getRemainingSeconds } from "../time";
import { clamp, lerp, safeDiv, getBasketballPossessions } from "../utils";
