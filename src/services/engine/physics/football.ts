import { Sport, OddsSnapshot } from "../../../types";
import { ExtendedMatch, TeamEfficiencyMatrix, FairTotalActive } from "../../../types/engine";
import { SYSTEM_GATES } from "../../../config/gates";
import { getStatNumber, parseStatNumber, clamp, lerp } from "../utils";
