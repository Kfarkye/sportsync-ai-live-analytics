import { Match, Sport, ExtendedMatch, OddsSnapshot, AISignals, MarketBlueprint, MarketScope, EdgeEnvironmentTag } from "../../../types";
import { SYSTEM_GATES } from "../../../config/gates";
import { isFootball, clamp } from "../utils";
import { getOddsValue } from "../../../utils/oddsUtils";
