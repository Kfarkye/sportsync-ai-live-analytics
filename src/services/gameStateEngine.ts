...
import { SYSTEM_GATES } from "../config/gates";
import {
    getElapsedSeconds,
    getRemainingSeconds,
...
import { calculateHockeyFairTotal, calculateHockeyEfficiency } from "./engine/physics/hockey";
import { calculateBasketballEfficiency, calculateBasketballFairTotal } from "./engine/physics/basketball";
import { calculateFootballEfficiency, calculateFootballFairTotal } from "./engine/physics/football";
import { calculateBaseballEfficiency, calculateBaseballFairTotal } from "./engine/physics/baseball";
...
import { calculatePregameConstraints } from "./engine/signals/pregame";
...
// The getCanonicalOdds function is now imported from "./engine/market"
