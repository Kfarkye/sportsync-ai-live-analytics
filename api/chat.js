...
function getPublicOrigin() {
    // Satellite URLs must be browsable by Gemini's urlContext tool.
    // Custom domains (thedrip.bet) get blocked. Firebase Hosting (*.web.app)
    // is a Google domain and passes urlContext validation.
    // The apiProxy Cloud Function proxies /api/* → Vercel, so the data path is intact.
